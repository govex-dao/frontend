...
export function TradeInsight(props: TradeInsightProps) {
    const {
        isBuy,
        setIsBuy,
        selectedOutcome,
    ...
    const outcomeClass = getOutcomeClass(selectedOutcomeIndex, outcomeMessages.length);
            ...
            <div>
                ...
                <p className="leading-relaxed mt-2.5 text-xs">
                    ...
                    {truncatedMessage !== outcomeMessage ? (
                        ...
                        >
                            <strong className={`${outcomeClass} cursor-help`}>{truncatedMessage}</strong>
                        </Tooltip>
                    ) : (
