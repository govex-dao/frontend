...
import type { MultisigConfig, IntentSummary, VaultStreamInfo, AccountVestingInfo, VaultCoinBalance, LockedCurrency, LockedPackageInfo, OwnedObjectInfo } from '../lib/sui/multisig';
