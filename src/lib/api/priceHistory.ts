...
export async function fetchProposalPriceHistory(proposalId: string): Promise<ProposalPriceHistoryResponse> {
  return api.get<ProposalPriceHistoryResponse>(`/api/proposals/${proposalId}/price-history`);
}
